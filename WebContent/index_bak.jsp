    ...
    <div id="wrapper">
                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li class="divider"></li>
                                <li><a href="hplus/login.html">安全退出</a>
                                </li>
                            </ul>
                        </div>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li class="dropdown">
                            <a class="dropdown-toggle count-info" data-toggle="dropdown" href="hplus/#">
                                <i class="fa fa-envelope"></i> <span class="label label-warning">16</span>
                            </a>
                            <ul class="dropdown-menu dropdown-messages">
                                <li class="m-t-xs">
                                    <div class="dropdown-messages-box">
                                        <a href="hplus/profile.html" class="pull-left">
                                ...
                                <li>
                                    <div class="text-center link-block">
                                        <a class="J_menuItem" href="hplus/mailbox.html">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-alerts">
                                ...
                                <li>
                                    <div class="text-center link-block">
                                        <a class="J_menuItem" href="hplus/notifications.html">
                                            <strong>查看所有 </strong>
                        ...
                        <li class="hidden-xs">
                            <a href="hplus/index_v1.html" class="J_menuItem" data-index="0"><i class="fa fa-cart-arrow-down"></i> 购买</a>
                        </li>
            ...
            <div class="row content-tabs">
                ...
                <a href="hplus/login.html" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
        ...
        <div id="right-sidebar">
            <div class="sidebar-container">
                ...
                <ul class="nav nav-tabs navs-3">
                    ...
                    <li class="active">
                        <a data-toggle="tab" href="hplus/#tab-1">
                            <i class="fa fa-gear"></i> 主题
                        </a>
                    </li>
                    <li class=""><a data-toggle="tab" href="hplus/#tab-2">
                        通知
                    </a>
                    </li>
                    <li><a data-toggle="tab" href="hplus/#tab-3">
                        项目进度
                    </a>
                    </li>
                </ul>
    ...
    <script type="text/javascript">
    	...
    	function printMenu(menu){
    		...
    		if(null!=menu.childMenu && menu.childMenu.length>0){//如果它有下一级
    			...
    			for(var i=0;i<menu.childMenu.length;i++){//就输出它所有的下一级
    				printMenu(menu.childMenu[i]);
    			}
                str+='</ul>';
    		}
            str+='</li>';
